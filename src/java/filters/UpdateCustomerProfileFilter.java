...
public class UpdateCustomerProfileFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("UpdateCustomerProfileFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("UpdateCustomerProfileFilter:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("UpdateCustomerProfileFilter()");
        }
        StringBuffer sb = new StringBuffer("UpdateCustomerProfileFilter(");
