 ...
 * @author Asus
 */
public class UpdateServiceFilter implements Filter {
    ...
    public UpdateServiceFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("UpdateServiceFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("UpdateServiceFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("UpdateServiceFilter:doFilter()");
        }
        ...
        try {
            ...
            if(StringUtils.checkEmpty(serviceName) || StringUtils.checkEmpty(hourlyRate)) {
                ...
                request.setAttribute("parsedHourlyFormat", parsedHourlyRate);
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("UpdateServiceFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("UpdateServiceFilter()");
        }
        StringBuffer sb = new StringBuffer("UpdateServiceFilter(");
