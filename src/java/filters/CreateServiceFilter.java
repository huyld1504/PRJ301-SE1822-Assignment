 ...
 * @author Asus
 */
public class CreateServiceFilter implements Filter {
    ...
    public CreateServiceFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CreateServiceFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CreateServiceFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CreateServiceFilter:doFilter()");
        }
        ...
        try {
            ...
            if(service != null) {
                ...
                request.setAttribute("MESSAGE", "Hourly rate will be only double.");
                request.getRequestDispatcher("MainServlet?action=create-service-page&service_id="+serviceID+"&service_name="+serviceName+"&hourly_rate="+hourlyRate).forward(request, response);
            }
            else {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CreateServiceFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("CreateServiceFilter(");
