 ...
 * @author Asus
 */
public class ServiceMechanicDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean isDeleted = sm.deleteServiceMechanicByServiceID(serviceID);
            
            if(isDeleted) {
                response.sendRedirect("MainServlet?action=delete-service&serviceID="+serviceID);
            } else {
