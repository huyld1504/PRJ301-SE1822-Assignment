 ...
 * @author Thanh Vinh
 */
public class CarSalesRevenueReportByYearServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // lấy báo cáo doanh thu xe bán theo năm từ DAO
            SalePersonDAO salePersonDAO = new SalePersonDAO();
            ArrayList<Map<String, Object>> carSalesRevenueByYear = salePersonDAO.getCarSalesRevenueByYear();

            // lưu báo cáo vào request
            request.setAttribute("carSalesRevenueByYear", carSalesRevenueByYear);
            ...
            e.printStackTrace();
            request.setAttribute("ERROR", "Error generating Car Sales Revenue Report by Year!");
            request.getRequestDispatcher("MainServlet?action=sale-dashboard").forward(request, response);
        }
    }
