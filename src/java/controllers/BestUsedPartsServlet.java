 ...
 * @author Thanh Vinh
 */
public class BestUsedPartsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Lấy báo cáo phụ tùng sử dụng nhiều nhất
            SalePersonDAO salePersonDAO = new SalePersonDAO();
            ArrayList<Map<String, Object>> bestUsedParts = salePersonDAO.getBestUsedParts();
            ...
            e.printStackTrace();
            request.setAttribute("ERROR", "Error generating Best Used Parts Report!");
            request.getRequestDispatcher("MainServlet?action=sale-dashboard").forward(request, response);
        }
    }
